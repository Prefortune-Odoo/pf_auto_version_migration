...
class MigrationWizard(models.TransientModel):
    ...
    def action_create_ticket(self):
        ...
        if not self.name:
            raise ValidationError("Please fill in the Name field!")
        
        if not self.email:
            raise ValidationError("Please fill in the Email Address field!")
        
        if not self.po_number:
            raise ValidationError("Please fill in the Purchase Number field!")
