    ...
    var MigrationFormController = FormController.extend({
        ...
        start: function () {
            ...
            return this._super.apply(this, arguments).then(function () {
                ...
                if (record.data.active_state === 'finish') {
                    // Removed the 2000ms delay! Fire the status check immediately.
                    setTimeout(function () {
                        self._callMigrationStatusAPI();
                    }, 50); // Tiny 50ms delay just to ensure DOM elements are fully loaded
                }
            });
        },
        ...
        _callMigrationStatusAPI: function () {
            ...
            if (customModulesCount > 0) {
                ...
                // Instantly and aggressively hide the loading screen
                if (loadingDiv) {
